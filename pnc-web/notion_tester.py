...
This script will help you discover what databases are available 
and what data is inside them using your Notion integration.

Usage:
1. Install dependencies: pip install requests
2. Run: python notion_tester.py
"""
...
def main():
    print("Notion Integration Tester")
    print("="*50)
    
    # Get the integration token - either from environment or user input
    ...
    print("\n" + "="*50)
    print("Next steps:")
    print("1. If databases are found, copy their IDs to use in the web app")
    print("2. If no databases are found, make sure they're shared with your integration")
    print("3. The web app will automatically detect shared databases once this is done")
