...
const BYOCPage: React.FC = () => {
  const project = PROJECTS_DATA.find(p => p.id === 'byoc');
  
  if (!project) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-emerald-50 to-teal-50 flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-3xl font-bold text-gray-900 mb-4">BYOC Project Not Found</h1>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                <div>
                  ...
                  <p className="text-gray-700 mb-6">
                    The Bring Your Own Cup (BYOC) initiative is a campus-wide movement aimed at reducing single-use plastic waste by encouraging students and staff to use reusable cups. This initiative has successfully saved thousands of single-use cups since its launch.
                  </p>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700">Reducing single-use plastic waste across the campus significantly.</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700">Involving students and staff in sustainable practices.</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        <h3 className="font-bold text-lg text-gray-900">Sustainable Habits</h3>
                        <p className="text-gray-700">Promoting long-term changes in waste reduction behaviors.</p>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="container mx-auto px-4 text-center">
            <div className="max-w-4xl mx-auto bg-gradient-to-br from-emerald-500 to-teal-600 rounded-3xl p-12 text-white">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                Support the BYOC Initiative
              </h2>
              <p className="text-xl mb-8 text-emerald-100 max-w-2xl mx-auto">
                Join our movement to reduce plastic waste on campus
              </p>
